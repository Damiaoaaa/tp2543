...
<head>
  ...
  <title>My Pet Bird store : Order Details</title>
  <!-- Bootstrap -->
...
<?php
    try {
      ...
      $stmt = $conn->prepare("SELECT * FROM tbl_orders_a178816_fpt, tbl_staffs_a178816_fpt,
        tbl_customers_a178816_fpt WHERE
  ...
  <div class="row">
    ...
    <form action="orders_details.php" method="post" class="form-horizontal" name="frmorder" id="forder" onsubmit="return validateForm()">
      <div class="form-group">
          <label for="pid" class="col-sm-3 control-label">Product</label>
          <div class="col-sm-9">
            <select name="pid" class="form-control" id="pid" required>
          ...
          ?>
          <option value="<?php echo $productrow['fld_product_id']; ?>"><?php echo $productrow['fld_product_gender']."   ".$productrow['fld_product_name']; ?></option>
          <?php
          }
          $conn = null;
          ?>
...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      <div class="page-header">
        <center><h2>Products in This Order</h2></center>
      </div>
